...
def AmazonItems(sellerDF):
    ...
    for j in sellerDF.index:
        ...
        Amazon_lineDF = pd.DataFrame({"Amazon_Title": Amazon_title, "Amazon_Quant_Availible":Amazon_numAvailible, "Amazon_Price":Amazon_price, "Amazon_Currency":Amazon_currency, "Amazon_ImageURL":Amazon_thumbnail, "Amazon_Link":Amazon_link },index=[0])
